  ...
  document.body.style.backgroundColor = "white";
	...
	<?php
		...
		{ 
			...
			$q=mysqli_query($db,"SELECT * from books where name like '%$_POST[search]%' OR bid like '%$_POST[search]%' OR authors like '%$_POST[search]%' and department='$_POST[department]' ");
